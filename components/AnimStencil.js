...
function init() {
    ...
    planes = [
        new THREE.Plane( new THREE.Vector3( - 1 + params.planeX.constant, 0, 0 ), 0 ),
        new THREE.Plane( new THREE.Vector3( 0, -1 + params.planeY.constant, 0 ), 0 ),
        new THREE.Plane( new THREE.Vector3( 0, 0, -1 + params.planeZ.constant ), 0 )
    ];
    ...
    const ground = new THREE.Mesh(
        ...
        new THREE.ShadowMaterial( { color: 0xfff, opacity: 0.25, side: THREE.DoubleSide } ),
        { color: 0xffffff},
    );
